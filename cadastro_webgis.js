...
// @version      1.15.005
// @description  implementação MONITORAMENTO function monitorarPopup()
// @match        https://webgis.engefoto.com.br/portal/apps/webappviewer/index.html?id=6cbe01fc405f4834a8997f7897d286e9
// @grant        none
// ==/UserScript==

/*
	Este script não será implementado. apenas armazenado como referência para clique no botão function monitorarBotaoProximaFeicao() 
	Passei direto para versão 1.15
*/

(function() {
    'use strict';

	var versionamento = "1.15.005";
	...
	var numeroDePorta = "Apenas para automatico";
...
//----------------------------------------------
	...
	document.addEventListener('keydown', (event) => {
		if (event.ctrlKey && event.key === 'm') {
			...
			console.log(`Modo automático ${status}`);
		}
	});
	...
	function adicionarOuvinteBotaoMouse() {
		document.addEventListener('mousedown', function(event) {
			...
			if (modoAutomaticoAtivo && event.target.tagName === 'circle' && event.button === 0 && tipoCadastro === TipoCadastro.REVISAR_CHAVES) { // Clique esquerdo em um círculo
				...
				numeroDePorta = "Apenas para automatico";
