// ==UserScript==
// @name         NOVO CADASTRO Preenchimento Automático WebGIS 1.01
...
(function() {
	...
	var dadosObservação = "Número de porta:";
    ...
    function preencherObservacao() {
        ...
        if (campoObservacao) {
            ...
            if (campoObservacao.value.trim() === "") {
                campoObservacao.value = dadosObservação; // Insira aqui o texto desejado para o campo de Observação
