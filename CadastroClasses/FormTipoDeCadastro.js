// Defina `TipoCadastro` e `FormTipoCadastro` como variáveis globais para o Tampermonkey
...
window.FormTipoCadastro = function() {
    ...
    // Determina o rótulo com base na URL
    var bicLabel = '';
    ...
    document.getElementById('confirmarTipoCadastro').addEventListener('click', function() {
        ...
        // Aqui você pode chamar a função preencherCampos() caso seja necessário
    });
};
